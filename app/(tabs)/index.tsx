...
export default function HomeScreen(): React.JSX.Element {
  ...
  // 💡 FIX 3: Parse the layout times dynamically into your user's localized timezone
  const nextSessionTimeDisplay = nextSession 
    ? new Date(nextSession.session_timestamp).toLocaleTimeString([], { hour: 'numeric', minute: '2-digit' })
    : '--:--';

  const nextSessionDateDisplay = nextSession 
    ? new Date(nextSession.session_timestamp).toLocaleDateString([], { month: 'short', day: 'numeric', year: 'numeric' })
    : '';
